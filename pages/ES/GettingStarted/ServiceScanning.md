...
![comando nmap!](/assets/images/GettingStarter/ServiceScanning/1_01.png "Escaneo basico de un puerto en especifico con NMAP.")
...
![comando nmap!](/assets/images/GettingStarter/ServiceScanning/1_02.png "Escaneo basico de un puerto en especifico con NMAP.")
...
![comando nmap!](/assets/images/GettingStarter/ServiceScanning/2_01.png "Escaneo completo de todos los puertos para averiguar en que puerto esta ejecutandose el servicio telnet.")
...
![comando nmap!](/assets/images/GettingStarter/ServiceScanning/2_02.png "Resultado del escaneo anterior.")
...
![comando smb recursos!](/assets/images/GettingStarter/ServiceScanning/3_01.png "Listado de recursos compartidos.")
...
![comando smb login!](/assets/images/GettingStarter/ServiceScanning/3_02.png "Login sin usuario en un recurso compartido en especifico.")
...
![comando smb login!](/assets/images/GettingStarter/ServiceScanning/3_03.png "Login a un recurso con un usuario en especifico.")
...
![exploracion de recursos!](/assets/images/GettingStarter/ServiceScanning/3_04.png "Exploracion de un recurso y descarga de archivos.")

Conseguimos localizar nuestro archivo de interes flag.txt navegando un poco por el recurso compartido.

![flag obtenida!](/assets/images/GettingStarter/ServiceScanning/3_05.png "Visualizacion de flag para resolver el ejercicio.")
